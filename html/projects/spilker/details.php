...
$pageVars = array(
	...
	'category'=>$category,
	'js'	=>array('macy','projects','projects/spilker')
);
include('../../header.php');
?>
...
<section id="project-process" class="accent-bar">
	<div class="container clearfix">
		<div class="row outdent">
			...
			<div class="project-gallery col12x gd">
...
<section id="project-results" class="container">
	<div class="flex-row outdent flex-wrap flex-vcenter">
		<div class="col12x col7s col8m col4l">
			<h2 class="h3">The Final <span class="uiux">Design</span><span class="gd">Design</span> </h2>
			<p class="uiux"> Spilker Custom Homes has been using our design since completion in 2016</p>
		...
		<div class="col12x col5s col4m col4l">
			<a href="http://spilkercustomhomes.com" class="btn center-text display-block">Visit the live version</a>
		</div>
		<div class="project-gallery col12x ">
			<figure class="project-img gd">
				<img src="spilker-branding.jpg" alt="mockup of full branding system" class="">
			</figure>
			<figure class="project-img uiux">
