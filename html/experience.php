<section id="experience-section" class="experience section fp-auto-height">
		<div class="container">
            ...
            <section id="pointman-productdesigner" class="slide" data-anchor="pointman-productdesigner">
            ...
            <section id="pointman-uxengineer" class="slide" data-anchor="pointman-uxengineer">
				<div class="white-bg material flex-row work-item">
					<div class="job_details col7l col7m col6s col12x">
						<h2 class="heading-group no-margin">
			...
			<section id="dsu-fulltime" class="slide" data-anchor="dsu-web-dd">
				<div class="white-bg material flex-row work-item">
					<div class="job_details col7l col7m col6s col12x">
						<h2 class="heading-group no-margin">
			...
			<section id="intern-exp" class="slide" data-anchor="dsu-internship">
				<div class="white-bg material flex-row work-item">
			...
			<section id="spilker-exp" class="slide" data-anchor="spliker-contract">
				<div class="white-bg material flex-row work-item">
					<div class="job_details col7l col7m col6s col12x">
						<h2 class="heading-group no-margin">
