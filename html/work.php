		...
		<div class="container">
			...
			<section id="uiux1" class="works-gallery slide" data-anchor="uiuxgallery1">
				...
				<div class="row">
                    <div id="ui-pm-home-maintenance" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-pm-ux-research" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-pm-customer-summary" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
                    ...
                    <div id="ui-pm-tech-exp" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-pm-reporting" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
                    ...
                    <div id="ui-pm-iq" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
            ...
            <section id="uiux2" class="works-gallery slide"data-anchor="uiuxgallery2">
				...
				<div class="row side-outdent">
					...
					<div id="strange-horizons" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-critiqueit" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-personal" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="ui-flickerfeed" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<!-- <div id="ui-weefee" class="work-item-wrapper">
					<article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="uiux-spilker" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
					...
					<div id="uiux-campusmaps" class="work-item-wrapper">
                        <article class="white-bg work-listing-inner pad1 material clearfix">
